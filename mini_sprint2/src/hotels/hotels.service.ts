...
export class HotelsService {
  ...
  // New service method for retrieving hotels near an airport and sorting offers by price
  // async findBestOffersNearAirport(airportId: number, radius: number): Promise<any> {
  ...
  //       {
  //         model: PriceOffer,
  //         required: true,  // Ensure that only hotels with offers are included
  //         order: [['Price', 'ASC']],  // Sort by price (lowest first)
  //       }
  //     ],
